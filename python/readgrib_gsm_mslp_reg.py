...
def plotmap(fcst_time, sta, lons_1d, lats_1d, lons, lats, mslp, rain, uwnd, vwnd, wspd, title, output_filename):
    #
    # MapRegion Classの初期化
...
if __name__ == '__main__':
    ...
    for fcst_time in np.arange(fcst_str, fcst_end+1, fcst_step):
        ...
        # 作図
        plotmap(fcst_time, sta, lons_1d, lats_1d, lons, lats, mslp, rain, uwnd, vwnd, wspd, \
