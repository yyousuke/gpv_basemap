...
def plotmap(fcst_time, sta, lons_1d, lats_1d, lons, lats, mslp, rain, title, output_filename):
    ...
    m = Basemap(projection='lcc', lon_0=135, lat_0=35, llcrnrlon=lon_min, urcrnrlon=lon_max, llcrnrlat=lat_min, urcrnrlat=lat_max, resolution=mres)
    # 図法の座標系に変換
    x, y = m(lons, lats)
    #
    # 緯度線、経度線を引く
    ...
    # 等圧線をひく
    if opt_c1:
        m.contour(x, y, mslp, levels=levels1, colors='k', linestyles=':', linewidths=0.8)
